        ...
        if (isMusl()) {
          ...
          try {
            if (localFileExisted) {
              ...
              nativeBinding = require('hello-napi-linux-arm-musleabihf')
            }
          } catch (e) {
            loadError = e
          }
        ...
        if (isMusl()) {
          ...
          try {
            if (localFileExisted) {
              ...
              nativeBinding = require('hello-napi-linux-riscv64-musl')
            }
          } catch (e) {
            loadError = e
          }
          ...
          try {
            if (localFileExisted) {
              ...
              nativeBinding = require('hello-napi-linux-riscv64-gnu')
            }
          } catch (e) {
            loadError = e
          }
      ...
      case 's390x':
        ...
        try {
          if (localFileExisted) {
            ...
            nativeBinding = require('hello-napi-linux-s390x-gnu')
          }
        } catch (e) {
          loadError = e
        }
...
const { JobStatusEnum, getUserFromEnv, grabVirajmSite, grabVirajmSiteAsync, getTimeAndNfl, SolutionType, solveQuadratic, sleepy, Client } = nativeBinding

module.exports.JobStatusEnum = JobStatusEnum
